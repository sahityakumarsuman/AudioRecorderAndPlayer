...
public class AndroidUtils {
    ...
    public static void runOnUIThread(Runnable runnable, long delay) {
        if (delay == 0) {
            PlayerRecorderApplication.applicationHandler.post(runnable);
        } else {
            PlayerRecorderApplication.applicationHandler.postDelayed(runnable, delay);
        }
    }

    public static void cancelRunOnUIThread(Runnable runnable) {
        PlayerRecorderApplication.applicationHandler.removeCallbacks(runnable);
    }
